    ...
    function roteador() {
        ...
        if (hash.startsWith('#post-')) {
            ...
            if (post && converterDataParaComparacao(post.date) <= hoje) {
                ...
                catLink.href = (post.category === "ensaios e provocações") ? "#cat-ensaios" : (post.category === "conversas") ? "#cat-conversas" : "#caminhos": (post.category === "poesia e música") ? "#cat-poesias" : "#caminhos";
