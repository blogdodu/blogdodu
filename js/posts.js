...
// 0025. um beijo
	{
		...
		content:
		`
				<p>todo gesto tem uma história, mas poucos carregam tantas quanto o beijo.....</p>
			<br>
			...
			<br>
				...
				<p>ou o beijo de "esquimó", de muitas etnias inuit, que não é exatamente um esfregar de narizes como a caricatura popular ensinou, mas um cheirar, um inalar o cheiro do outro..... como se a intimidade estivesse não na pressão dos lábios, mas no ar que o corpo da outra pessoa exala.....</p>
				...
				<p>porém, beijar, em suas mil formas, é só uma das respostas que a humanidade encontrou para essa necessidade de proximidade.....</p>
			...
			<br>
				...
				<p>no mais, até mais!!!!</p>
					...
					<br>
						...
						<p>no último texto, tivemos comemoramos nosso natal, primeiro ensaio decolonial sobre os sabbats.....</p>
...
// 0022. semelhantes diferenças
	...
	// 0014. descortinando o pudor
	{
		id: "descortinando-o-pudor-entre-a-intimidade-e-a-autenticidade-ed12",
		title: "descortinando o pudor: entre a intimidade e a autenticidade - ed12",
		date: "2026.mai.04",
		readingTime: "4 min de leitura",
		category: "ensaios e provocações",
		categoryId: "#ways",
		...
		`
				...
				<p>mas será que é apenas isso????</p>
				<p>vamos explorar o conceito e suas nuances, desvendando o seu papel em nossas vidas....</p>
				<p>como por que cobrimos tanto nossos corpos em casa ou num ambiente de trabalho, achando estranho, deselegante ou apenas fora de contexto uma maior exposilçao da pele, enquanto na praia ou na piscina exigimos e nos é exigido o oposto????</p>
				<p>ou por que mamilos femininos são tão reprimidos enquanto os masculinos são aceitos????</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ as múltiplas faces do pudor ♦</strong></p>
			<br>
				<p>o pudor é como um camaleão social, assumindo diferentes formas e cores dependendo do contexto em que se manifesta....</p>
				<p>ele pode ser físico, relacionado ao corpo e à intimidade; emocional, ligado aos sentimentos e vulnerabilidades; social, vinculado às normas de comportamento; ou até mesmo intelectual, quando hesitamos em expressar idéias que possam ser julgadas....</p>
				<p>essa multiplicidade revela que o pudor não é simplesmente uma barreira, mas um complexo sistema de filtros através dos quais negociamos nossa presença no mundo....</p>
				<p>como escreveu simone de beauvoir, "o pudor não é senão a recusa de ser vista, de ser objeto"....</p>
				<p>mas será que essa recusa sempre nos protege, ou às vezes nos aprisiona???</p>
				<p>quando age como barreira cultural, o pudor é um espelho distorcido, refletindo-se de maneira distinta em cada sociedade.....</p>
				<p>é um código silencioso que regula as interações humanas, as vestimentas, a linguagem corporal e até mesmo as expressões verbais.....</p>
				<p>mergulhar nesse universo é como desbravar um oceano de complexidades culturais, onde cada cultura tece seu próprio tecido de normas, regras e convenções....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ o pudor através das culturas ♦</strong></p>
			<br>
				<p>em algumas destas convenções, ele é um escudo protetor, preservando a intimidade e a dignidade individual...</p>
				<p>em outras, é um véu que esconde, por vezes, a verdadeira essência dos indivíduos....</p>
				<p>seja como for, o pudor se entrelaça com os valores arraigados em cada sociedade, delineando fronteiras, muitas vezes, invisíveis, mas profundamente enraizadas.....</p>
				<p>o antropólogo claude lévi-strauss observou que mesmo nas sociedades onde a nudez física é comum, existem outras formas de pudor – tabus linguísticos, comportamentais ou rituais....</p>
				<p>isso sugere que o pudor não é apenas uma construção cultural arbitrária, mas talvez uma necessidade humana de estabelecer fronteiras entre o público e o privado....</p>
				<p>nas sociedades ocidentais contemporâneas, testemunhamos uma curiosa contradição:</p>
				<p>por um lado, uma aparente liberação dos corpos e das expressões; por outro, novas formas de pudor emergem, especialmente no campo digital e emocional....</p>
				<p>compartilhamos fotos íntimas, mas protegemos ferozmente nossos dados pessoais; expomos detalhes de nossas vidas nas redes sociais, mas criamos personas cuidadosamente editadas....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ tabus e fronteiras invisíveis ♦</strong></p>
			<br>
				<p>os tabus sociais, por sua vez, são muralhas erguidas em torno dessa 'virtude'...</p>
				<p>eles são construídos a partir de crenças coletivas, marcando o que deve ser permitido e o que é estritamente proibido, delineando as fronteiras do comportamento aceitável...</p>
				<p>o pudor, nesse contexto, atua como um guardião desses tabus, refletindo as expectativas sociais e moldando as interações humanas....</p>
				<p>no entanto, esses tabus também podem se mostrar como prisões invisíveis, restringindo a expressão genuína do indivíduo e dificultando a evolução de conceitos e idéias progressistas....</p>
				<p>foucault argumentava que os tabus relacionados ao corpo e à sexualidade não são apenas repressivos, mas também produtivos – eles criam discursos, identidades e formas de resistência....</p>
				<p>quando questionamos esses tabus, não estamos apenas rejeitando limitações, mas reimaginando possibilidades de existência....</p>
				<p>a intersecção entre o pudor, a cultura e os tabus sociais revela-se como um terreno fértil para análises profundas....</p>
				<p>é uma área onde as raízes da sociedade se entrelaçam, onde as normas sociais são formadas e moldadas, e onde a delicada balança entre a preservação da individualidade e a integração social é constantemente desafiada.....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ entre máscaras e vulnerabilidades ♦</strong></p>
			<br>
				<p>a dicotomia entre ser autêntico e respeitar o que se entende como pudor é um dos desafios mais sutis e complexos da jornada humana....</p>
				<p>a busca pela autenticidade, muitas vezes, se choca com essas fronteiras construídas socialmente....</p>
				<p>é como navegar entre correntes, buscando um equilíbrio delicado entre expressar quem somos e respeitar as nuances que compõem nossos pudores...</p>
				<p>usamos diferentes máscaras em diferentes contextos....</p>
				<p>o pudor pode ser visto como o guardião dessas máscaras, determinando quando e como as removemos....</p>
				<p>mas também pode ser o que nos impede de experimentar a libertação de mostrar nosso verdadeiro rosto....</p>
				<p>a vulnerabilidade – "tanta vontade de devorá-la, de arder em você, delicada água-viva" – é tanto o oposto do pudor quanto sua razão de ser....</p>
				<p>é precisamente porque a vulnerabilidade é poderosa e transformadora que desenvolvemos mecanismos para protegê-la....</p>
				<p>o psicólogo carl rogers sugeria que é apenas quando nos permitimos ser verdadeiramente vistos que podemos crescer e nos conectar profundamente....</p>
				<p>"o curioso paradoxo é que quando me aceito como sou, então posso mudar"....</p>
				<p>talvez o mesmo possa ser dito sobre o pudor: quando aceitamos nossas vulnerabilidades, podemos escolher conscientemente o que revelar e o que preservar....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ o pudor nos relacionamentos ♦</strong></p>
			<br>
				<p>na teia dos relacionamentos interpessoais, ele é uma dança entre revelar e preservar....</p>
				<p>ele dita o ritmo das trocas verbais e não verbais, determinando o que é dito e o que permanece calado......</p>
				<p>sua presença pode fortalecer os laços ao proteger informações sensíveis, mas também pode se tornar uma barreira, limitando a profundidade das conexões emocionais....</p>
				<p>compreender e respeitar os limites individuais do pudor é essencial para estabelecer uma comunicação sincera e autêntica nos relacionamentos....</p>
				<p>o filósofo emmanuel levinas falava sobre como o encontro com o "rosto do outro" nos convoca a uma responsabilidade ética....</p>
				<p>o pudor, nesse sentido, pode ser visto como um reconhecimento dessa responsabilidade – um cuidado com o que revelamos e como isso afeta o outro....</p>
				<p>não é apenas sobre proteger a nós mesmos, mas também sobre honrar a sensibilidade alheia....</p>
				<p>nos relacionamentos íntimos o pudor se dissolve gradualmente, criando espaço para uma vulnerabilidade compartilhada: "dedos acariciando a pele quente, suavemente dos pés a cabeça"....</p>
				<p>essa dissolução não é uma negação do pudor, mas sua transformação em confiança mútua....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ pudor e desenvolvimento pessoal ♦</strong></p>
			<br>
				<p>o pudor e o desenvolvimento pessoal estão intrinsecamente ligados...</p>
				<p>como uma voz interior que nos impede de ousar, de nos aventurarmos além das fronteiras do conhecido....</p>
				<p>ao nos apegarmos aos limites impostos por ele, podemos nos encontrar em uma zona de conforto estática, onde o crescimento e a evolução são cerceados pela hesitação e pelo medo da não aceitação.....</p>
				<p>ao compreendermos que a autenticidade não necessariamente significa expor cada detalhe de nossa essência, mas sim compartilhar aquilo que nos faz genuínas(os), preservando o que nos é caro, encontramos o caminho para uma expressão autêntica que respeita os limites da reserva sem se perder na artificialidade.....</p>
				<p>lembre que cada momento é uma oportunidade de recomeço....</p>
				<p>o pudor também opera em ciclos – momentos de abertura seguidos de recolhimento, expansão e contração....</p>
				<p>não precisamos esperar por um momento específico para redefinir nossa relação com o pudor; podemos fazê-lo a qualquer instante, reconhecendo que somos seres em constante transformação....</p>
				<p>o filósofo søren kierkegaard escreveu sobre o "salto de fé" – aquele momento em que abandonamos as certezas e nos lançamos no desconhecido....</p>
				<p>se sentir segura(o) e desafiar nosso próprio pudor pode ser um interessante salto, um ato de coragem que nos permita descobrir novas dimensões de nós mesmas(os)....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ o equilíbrio delicado ♦</strong></p>
			<br>
				<p>conciliar a autenticidade com o respeito aos limites pessoais demanda uma jornada de autoconhecimento e compreensão profunda de nossos valores....</p>
				<p>é um convite a explorar os meandros de nossa identidade, reconhecendo os espaços onde o pudor se alinha com nossas convicções mais íntimas e onde pode ser desafiado de forma construtiva.....</p>
				<p>a chave está em encontrar um terreno comum onde a verdadeira expressão do ser encontra-se em harmonia com os limites que resguardam a individualidade, permitindo que ambos coexistam em um equilíbrio dinâmico....</p>
				<p>esse equilíbrio delicado entre a autenticidade e o respeito ao pudor não é uma fórmula pronta, mas sim um processo contínuo de aprendizado e adaptação....</p>
				<p>e construir relações saudáveis é um exercício de equilíbrio entre respeitar a reserva de cada indivíduo e cultivar a intimidade...</p>
				<p>estratégias como a prática da empatia, o estabelecimento de limites claros e a criação de um ambiente de confiança são fundamentais nesse processo....</p>
				<p>reconhecer e respeitar o espaço de cada pessoa, compreendendo suas particularidades e aceitando suas fronteiras, é a base para a construção de vínculos sólidos e respeitosos, onde a comunicação flui naturalmente, sem desconsiderar a individualidade de cada uma(m).....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ pudor na era digital ♦</strong></p>
			<br>
				<p>em nossa era de hiperexposição, o pudor assume novas dimensões....</p>
				<p>as redes criaram um paradoxo: nunca estivemos tão expostos e, ao mesmo tempo, tão cuidadosamente escondidos em editações e editoriais pessoais....</p>
				<p>compartilhamos momentos íntimos com estranhos, mas através de filtros – tanto literais quanto metafóricos....</p>
				<p>o filósofo byung-chul han, em sua obra "sociedade da transparência", alerta para os perigos de um mundo onde tudo deve ser visível, onde o pudor é visto como obstáculo à comunicação total....</p>
				<p>ele argumenta que certa opacidade é necessária para preservar nossa humanidade, que nem tudo deve ser exposto à luz implacável da transparência digital....</p>
				<p>talvez o desafio de nossa época seja redescobrir o valor do pudor não como repressão, mas como curadoria consciente – escolher deliberadamente o que compartilhamos e o que mantemos privado, não por medo ou vergonha, mas por um profundo respeito pelo sagrado em nós....</p>
				<p>e nem me refiro a perfis dix ou daily....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ o pudor como autodeterminação ♦</strong></p>
			<br>
				<p>por último e para terminar (rsrsrr), entender o papel do pudor é navegar por entre as nuances da conexão humana...</p>
				<p>é reconhecer que o respeito aos limites individuais é essencial para uma convivência saudável e para o florescimento de relações autênticas e significativas...</p>
				<p>talvez a visão mais libertadora do pudor seja encará-lo não como uma imposição externa, mas como uma escolha – um ato de autodeterminação....</p>
				<p>não se trata de esconder por vergonha, mas de revelar por escolha; não de reprimir por medo, mas de preservar por valor....</p>
				<p>como sugere a filósofa judith butler, nossos corpos e identidades são performativos – estamos constantemente "fazendo" quem somos através de nossas ações e escolhas....</p>
				<p>o pudor, nessa perspectiva, não é uma essência fixa, mas uma performance que podemos, e diria até que devemos, individualmente e coletivamente, modificá-la, questioná-la e reinventá-la....</p>
				<p>e agora, te convido a refletir....</p>
				<p>como o pudor se manifesta em sua vida????</p>
				<p>ele tem sido uma barreira ou um portal seguro para a sua expressão mais verdadeira???</p>
				<p>em um mundo que valoriza a transparência, onde você desenha a linha entre o que é público e o que é privado??</p>
				<p>e, olhando para o futuro, como podemos ressignificar o pudor coletivamente, de forma que ela abrace a diversidade de expressões sem perder o seu valor essencial?????</p>
				<p>talvez, como sugere o poema "jellyfish", a verdadeira intimidade aconteça quando permitimos que alguém veja além de nossas camadas protetoras: "ah! quantas vezes você viu as estrelas naquela noite!!!"....</p>
				<p>quando encontramos aqueles com quem podemos ser vulneráveis, o pudor se transforma de barreira em portal – não uma negação da proteção, mas sua transcendência em conexão profunda....</p>
				<p>no mais, até mais!!!</p>


			<br>
				<p>quer experimentar textos mais poéticos e artísticos???</p>
				<p>no último texto, comecei a compartilhar poesias.....</p>
				<p>vale a pena conferir!...</p>
			<br>
				<p><strong><center>♦ ensaios novos às segundas ♦</center></strong></p>
				<p><center>__________________________________</center></p>
	...
	// 0012. meus eus e os outros
	{
		...
		`
			...
			<br>
				...
				<p>vivemos num teatro onde nos fragmentamos, constantemente usando esses adereços para atender às demandas de nosso meio, da sociedade, dos papéis que escolhemos ou fomos forçadas(os) a desempenhar....</p>
				...
				<p>é, justamente, essa pluralidade que nos faz únicas(os), nos faz personalidades múltiplas, nos faz coisas inteiras, ainda que sempre divididas entre as expectativas externas e os diálogos internos.....</p>
			...
			<br>
				...
				<p>elas não são apenas disfarces, mas também uma tentativa de comunicar (expressar) e se comunicar (conectar) com outra pessoa/realidade.....</p>
			...
			<br>
			<hr class="divisor-fino-longo">
				<p><strong>♦ a máscaras digitais♦</strong></p>
			<br>
			...
			<br>
				...
				<p>é necessário, sobretudo, abraçar as falhas, as partes nossas que não se encaixam nas expectativas....</p>
				<p>é reconhecer o desconforto, a fragilidade e, a partir disso, seguir em frente..</p>
				<p>mas o caminho da aceitação não é linear e raramente é fácil, muitas vezes, envolve confrontar quem pensamos ser com quem realmente somos...</p> 
				<p>e esse encontro pode ser perturbador, porque nos obriga a tirar as máscaras e, pela primeira vez, encarar a verdade nua e crua......</p>
			...
			<br>
				...
				<p>um esvaziamento necessário para que possamos, como eu diria, ir até o papel em branco que sempre fomos, somos e seremos....</p>
			...
			<br>
				<p>quer mergulhar em outras reflexões profundas???</p>
				<p>no último texto, fechamos a trilogia dos "pais opressores" com o estado.....</p>
				<p>vale a pena conferir!...</p>
			<br>
				<p><strong><center>♦ ensaios novos às segundas ♦</center></strong></p>
				<p><center>__________________________________</center></p>
	...
	`
		...
		<br>
		<hr class="divisor-fino-longo">
			<p><strong>♦ o paradoxo ♦</strong></p>
		<br>
			<p>essa afirmação, tão proclamada em debates filosóficos e conversas cotidianas, muitas vezes serve como ponto de partida para discussões sobre a natureza da verdade e da certeza....</p>
			<p>discordo totalmente de tal afirmação, que já em si, paradoxalmente, é uma inverdade..…</p>
			<p>ao refletirmos mais profundamente sobre essa questão, podemos chegar a uma conclusão surpreendente: só existem verdades absolutas, todas verdades são assim, absolutas, e, portanto, não há espaço na existência 	para meias-verdades ou verdades parciais...</p>
		<br>
		<hr class="divisor-fino-longo">
			<p><strong>♦ o que define uma verdade??? ♦</strong></p>
		<br>
			<p>entenda, verdades são aquelas coisas que simplesmente acreditamos que são e pronto.... isso porque se não acreditamos 100% em uma verdade, qualquer mísera percentagem de incerteza que exista, já é o suficiente 	para não haver mais convicção nessa ou naquela verdade..... que agora já passou a ser uma dúvida, ou quem 	sabe, no máximo, uma quase verdade, que na verdade não é uma verdade....</p>
			<p>mas fique calma(o), as verdades, mesmo todas sendo absolutas, não são, em si, eternas e universais, mesmo as que de fato sejam verdades universais....</p>
			<p>explico, as verdades são pertencentes a cada pessoa, são escravas de nossos conhecimentos e experiências e do nosso arcabouço de verdades.... e assim sendo, só nós somos suas(eus) senhoras(es), suas(eus) 	deusas(es) criadoras(es) e as(os) únicas(os) com poder para dotá-las e destituí-las do título de 	verdade…</p>
			<p>o que realmente faz delas verdades é a capacidade de resistirem, de serem absolutas, quando confrontadas por outras que queiram ser verdades no seu lugar.....</p>
			<p>portanto, nenhuma verdade criada por nós, simplesmente acaba e deixa um buraco em seu lugar, uma fissura ou um abismo de dúvidas... elas só são destronadas e substituídas por outras verdades mais fortes, maiores 	e mais verdadeiras, porém igualmente absolutas quanto suas antecessoras, um dia, assim, foram...</p>
		<br>
		<hr class="divisor-fino-longo">
			<p><strong>♦ a dança das verdades: ciência e sociedade ♦</strong></p>
		<br>
			<p>pra exemplificar essa dinâmica da construção de verdades, podemos considerar o cenário da evolução científica ao longo da história.... no passado, muitas verdades absolutas eram aceitas sem questionamento, 	como a idéia de que a terra era plana ou o geocentrismo, que colocava a terra como o centro do 	universo....</p>
			<p>no entanto, com o avanço da ciência e a busca e a acumulação de novos conhecimentos e evidências, essas verdades foram sendo substituídas por outras mais fundamentadas e abrangentes....</p>
			<p>além disso, é importante dizer que a construção de novas verdades não ocorre de forma isolada, mas sim em um contexto social e cultural específico..... onde outras realidades, outras pessoas, nos confrontam com 	uma possível verdade melhor que a que carregamos e protegemos...</p>
			<p>é preciso coragem de colocar nossas verdades à prova, conhecendo a fundo cada outras verdades que as desafiem.....</p>
			<p>essas outras, até então, para nós, apenas possíveis verdades, também foram construídas em crenças e valores de uma outra pessoa e da sociedade que a influencia, afetando diretamente na forma de sua concepção 	e aceitação, e são tão absolutas para ela quanto as nossas são para nós…</p>
			<p>por isso é que é impossível convencer alguém de que o que ela(e) acredita não seja verdade..... por que na realidade do outro é....</p>
		<br>
		<hr class="divisor-fino-longo">
			<p><strong>♦ a (des)construção interna da verdade ♦</strong></p>
		<br>
			<p>você não possui os mesmos conhecimentos, as mesmas vivências, experiências que permitiram àquela verdade de outrem ser construída em si...</p>
			<p>cada pessoa precisa conseguir construir, por si só, consigo mesma(o), uma verdade maior que a que possui, para que ela possa ocupar o espaço daquela que já o preenche até então...</p>
			<p>este processo leva tempo, requer a reunião de novos materiais e, principalmente, depende da vontade de se munir, a cada dia, de melhores verdades e de, ao se deparar com uma, conseguir enxergá-la e aceitar 	abandonar a que antes carregava e agora só lhe atrapalha....</p>
			<p>e é por isso que diferentes culturas podem ter sistemas de crenças e verdades distintos......</p>
		<br>
		<hr class="divisor-fino-longo">
			<p><strong>♦ convite à reflexão e ao diálogo ♦</strong></p>
		<br>
			<p>dessa forma, a manutenção, o abandono e a busca pelas verdades absolutas que estão sob nosso domínio, é uma jornada complexa e multifacetada, que envolve não apenas a racionalidade individual, mas também as 	dinâmicas coletivas de uma sociedade e de uma realidade em constante transformação....</p>
			<p>ao reconhecermos a relatividade e mutabilidade das verdades, abrimos espaço para o diálogo, a reflexão e o aprendizado constante, fundamentais para o progresso e a evolução....</p>
			<p>mas só existem verdades absolutas, tudo mais são apenas dúvidas...</p>
		<br>
		<br>
		<br>
			<div class="pos-scriptum">
					<p><strong>ps.:</strong> ou não...</p>
					<p>...será????</p>
			</div>
		<br>
		<hr class="divisor-fino-longo">
		...
		<br>
			<p>gostou do que leu???</p>
			<p>compartilhe suas verdades conosco.....</p>
			<p>sua opinião é importante....</p>
		<br>
			<p><strong><center>♦ ensaios novos às segundas ♦</center></strong></p>
			<p><center>__________________________________</center></p>
	...
	// 0001. o recomeço
	{
		...
		author: "du",
		authorId: "#authors",
		image: "/img/post-recomeco.png",
		imageAlt: "du em múltiplas perspectivas nos espelhos",
		imageCaption: "\"estar...\"",
		content:
		`
				<p><center>nunca é tarde pra começar, ou recomeçar, dependendo da situação...</center></p>
			<br>
			<hr class="divisor-fino-longo">
				<p>em um mundo frenético e digital, onde a atenção se esvai em um piscar de olhos, surge o <strong>blog do du</strong>, um refúgio para almas inquietas e corações pulsantes....rsrsrsr</p>
				<p>aqui, entre letras minúsculas e pontuação exuberante, convido você a se juntar a uma comunidade vibrante, onde a arte, a filosofia, a vida e a organização se entrelaçam em um caleidoscópio de idéias e reflexões....</p>
				<p>este blog, rascunhado de 2022 a 2024 e agora repaginado com novos ares, é mais do que um punhado de palavras na tela..... é um convite para uma jornada de autodescoberta, um espaço para cultivarmos a mente e o coração, um lar virtual onde a troca de idéias e a construção de laços genuínos são os pilares que busco para essa nossa comunidade.....</p>
			<br>
			<hr class="divisor-fino-longo">
				<p>seja você uma(m) artista nata(o), uma(m) filósofa(o) em construção, uma(m) amante da vida em suas nuances ou simplesmente alguém em busca de um espaço acolhedor para refletir, o <strong>blogdodu</strong> abre suas portas para você.....</p>
				<p>aqui, não há julgamentos, apenas a vontade genuína de compartilhar, aprender e crescer juntas(os).....</p>
			...
			<br>
				<div class="pos-scriptum">
						<p><strong>ps.:</strong> por aqui, eu prefiro as letras minúsculas, porque acredito que elas transmitem simplicidade, humildade e um toque de informalidade..... nada contra as maiúsculas, mas aqui todo mundo é simples e ninguém é maior que o outro....</p>
					<br>
						<p><strong>pps.:</strong> e a pontuação.... bom, ela é a forma de colocar pra fora tanta empolgação, inquietação e paixão que tenho pelas idéias que compartilho.... então, não se assuste com os pontos de exclamação e interrogação em abundância.... eles fazem parte da minha identidade!!!</p>
				</div>
			<br>
			<hr class="divisor-fino-longo">
			...
			<br>
				<p><center>o <strong>"blog do du"</strong> é apenas uma parte de mim e do que penso como projeto</center></p>
			<br>
			<br>
				<p><strong><center>♦ vamos construir um espaço rico em troca de idéias e reflexões ♦</center></strong></p>
			<br>
